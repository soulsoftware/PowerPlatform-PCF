...
export class TSLinearInputComponent implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public updateView(context: ComponentFramework.Context<IInputs>): void {
		if( this.labelElement && this.inputElement) { // Type Guards
	...
	*/
	...
	public refreshData(evt: Event): void {
		if( this.labelElement && this.inputElement) { // Type Guard
			this._value = Number(this.inputElement.value);
			this.labelElement.innerHTML = String(this.inputElement.value);
