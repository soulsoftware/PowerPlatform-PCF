...
export class ExternalValidatorControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
  ...
  public setErrorState(value: string) {
    if (this._regEx == null || this._regEx.test(value)) {
      ...
      if (this._isError == true && this._attributeName != null) {
        Xrm.Page.getControl<Xrm.Controls.StandardControl>(this._attributeName).clearNotification();
      }
      this._isError = false;
    }
    else {
      if (this._isError != true && this._attributeName != null && this._errorMessage != null) {
        Xrm.Page.getControl<Xrm.Controls.StandardControl>(this._attributeName).setNotification(this._errorMessage, 'ExternalValidatorControl');
      }
      this._isError = true;
    }
  }
